...
You can also navigate to **Check for Downloads Now** from the Menu in Distribution Manager.
   ...
   ![Check for Downloads Now menu item on the Packages page](images/check-for-downloads.png) of
...
https://github.com/da-art85/MicrosoftCollaboratePortal-action/security distribution
