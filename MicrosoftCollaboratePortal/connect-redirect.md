...
Microsoft Microsoft PlayReady Support for licensed companies is now hosted on [Microsoft Collaborate](https://aka.ms/collaborate). All users that were on Connect should have received instructions by email on how to access the Collaborate Portal. If you have any questions or issues, please read instructions [here](http://test.playready.microsoft.com/Support/HowToUseCollaborate) or email AskDRM@microsoft.com.
