...
1. Click on ![Settings](images/settings.png) **Settings** in the upper right corner and select [**My preferences**](https://developer.microsoft.com/en-us/dashboard/engagement/preference) item from the drop down menu.
